...
function App() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'equipment':
        return <div><h1 className="text-2xl font-bold">Gestione Attrezzature</h1><p className="text-gray-600 mt-2">Modulo in svilupup...</p></div>
      case 'nfc':
  ...
  // BYPASSA COMPLETAMENTE LOADING E LOGIN
  // if (loading) { ... }
